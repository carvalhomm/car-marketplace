...
const new_car_service_1 = require("../src/services/new-car.service");
const cars_list_service_1 = require("../src/services/cars-list.service");
const firebase_admin_1 = __importDefault(require("../src/firebase.admin"));
;
describe('test to see if works properly', () => {
    it('should insert a new car in the list', async () => {
        ...
        await new_car_service_1.setNewCar(carro);
        const docs = await firebase_admin_1.default.firestore().collection('carros').get();
    ...
    it('should get a list cars', async () => {
        const carros = await cars_list_service_1.getCars({ sortBy: 'preco', method: 'asc' });
